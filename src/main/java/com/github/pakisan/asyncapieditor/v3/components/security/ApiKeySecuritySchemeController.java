...
public class ApiKeySecuritySchemeController {
    ...
    @FXML
    private ComboBox<ApiKeySecurityScheme.ApiKeyLocation> in; // TODO: Required
    ...
    public void initialize() {
        ...
        var inVariants = new ArrayList<>(
                List.of(ApiKeySecurityScheme.ApiKeyLocation.values())
        );
